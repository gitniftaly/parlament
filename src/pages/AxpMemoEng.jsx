      ...
      >
        <header className="flex flex-col mt-4 justify-center items-center">
          <h1 className="font-bold px-2">
            Formation of the Azerbaijan Popular Parliament: A New Chapter for
            Democracy
          </h1>
        </header>
        <article className="mt-1 px-2 font-serif">
          ...
          announced the formation of the Azerbaijan Popular Parliament (APP).
          This bold initiative aims to restore democratic traditions, promote
          human rights, and dismantle systemic corruption. Drawing national and
          international attention, the APP calls for global solidarity in its
          quest for a democratic Azerbaijan.
        </article>
        <article className="flex flex-col">
          ...
          <span className="px-2 flex justify-center items-center font-serif">
            ...
            APP condemned these elections as a breach of Article 6 of the
        ...
        <article className="flex flex-col">
          <header className="flex m-auto py-2">
            <h1 className="font-bold">The Vision of the Popular Parliament</h1>
          </header>
          <section className="px-1 sm:px-2 font-serif">
            The APP positions itself as a democratic alternative to the current
            regime, rooted in the principles of transparency, justice, and
            accountability. Established through the collective efforts of
            Azerbaijani citizens at home and abroad, the APP outlines an
          ...
          <div className="px-1 sm:px-2 font-serif">
            The APP also seeks to rekindle Azerbaijan’s democratic heritage,
        ...
        <article className="flex flex-col">
          ...
          <div className="px-1 sm:px-2 font-serif">
            The APP has issued an urgent appeal to international organizations,
            ...
            examples of the regime’s manipulation of global platforms. The APP
